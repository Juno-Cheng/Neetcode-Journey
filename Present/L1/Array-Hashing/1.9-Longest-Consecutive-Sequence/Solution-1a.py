...
======================================
Thought Process:
- Brute Force Solution: Go through each element and check if the next element is consecutive. If it is, increment the counter. If it is not, reset the counter. Return the maximum counter.
